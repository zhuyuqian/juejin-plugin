...
import { handleApiResult, getAllJueJinTabs, uuid, sleep } from "./tool.js";
...
export const loopMessageNotReadCount = async () => {
	if (await getSelfInfoStorage()) {
		let res = await fetch('https://api.juejin.cn/interact_api/v1/message/count', {}).then(res => res.json());
